...
eval_dataset = [
    ...
    {
        "question": "모바일 포렌식 결과에서 이소연의 구글 계정 아이디는 무엇인가요?",
    ...
    {
        "question": "모바일 포렌식 결과에서 사무실 와이파이 MAC 주소는 무엇인가요?",
        "ground_truths": ["00:0a:95:9d:68:17"],
    },
    {
        "question": "모바일 포렌식 결과의 call log에서 강백호와 백사장은 총 몇번의 통화를 주고 받았나요?",
        "ground_truths": ["2번", "두 번", "2회", "두번"],
    },
    {
        "question": "모바일 포렌식 결과의 메세지에서 서태웅과 강백호는 어디서 만나기로 약속했나요?",
        "ground_truths": ["PC방"],
    },
    {
        "question": "모바일 포렌식 결과의 오디오에서 2024년1월7일 11시5분에 채치수와 통화한 녹음파일의 길이는 몇 분인가요?",
        "ground_truths": ["6분"],
    },
    {
        "question": "강백호는 노가다를 했습니다. 월급은 누구한테 받게 될까요?",
        "ground_truths": ["홍사장"],
    },
    {
        "question": "모바일 포렌식 결과에서 장치 시리얼 번호는 무엇인가요?",
        "ground_truths": ["ABC123"],
    },
    {
